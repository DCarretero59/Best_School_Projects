        ...
        switch (valorSentencia) {
            ...
            case "tkn_ID":
                if (sentencia.size() > 3) {
                    ...
                    for (int i = 0; i < postFixArray.length; i++) {
                        ...
                        switch (val) {
                            case "+": {
                                ...
                                codigoEnsamblador += temporal + "= " + OP1 + "+ " + OP2 + "\n";
                    ...
                    codigoEnsamblador += sentencia.get(0)[0][0] + "= " + postFixArray[postFixArray.length - 1] + "\n";

                } else if (sentencia.size() == 2) {
                    if (sentencia.get(1)[0][0].contains("+")) {
                        codigoEnsamblador = sentencia.get(0)[0][0] +" = " + sentencia.get(0)[0][0] + "+ 1\n";
                    }
                    if (sentencia.get(1)[0][0].contains("-")) {
                        codigoEnsamblador = sentencia.get(0)[0][0] +" = " + sentencia.get(0)[0][0] + "- 1\n";
                    }
                } else {
                    codigoEnsamblador += sentencia.get(0)[0][0] + "= " + sentencia.get(2)[0][0] + "\n";
                }
                break;
        }
